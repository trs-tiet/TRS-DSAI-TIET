...
import { feeNotes } from "@/data/registrationFees";
    ...
    <>
      ...
      <section className="bg-surface py-24">
        <div className="wrap grid md:grid-cols-[1.4fr_1fr] gap-16">
          <Reveal>
            <p className="text-[17px] text-fg mb-6 max-w-xl">
            ...
            <p className="text-[17px] text-fg max-w-xl">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-line">
            {[
              ...
              <Reveal key={item.title} delay={i * 0.08}>
                <div className="bg-surface p-9 h-full">
