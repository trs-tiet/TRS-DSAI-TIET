      ...
      <section className="bg-paper py-24">
        ...
        <div className="wrap mt-8">
          <p className="text-[13.5px] text-steel">
            Detailed session-by-session timing will be updated closer to the event — see{" "}
            <code className="bg-line px-1.5 py-0.5 rounded-sm">data/schedule.ts</code> to edit.
          </p>
        </div>
      </section>
