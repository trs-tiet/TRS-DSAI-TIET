...
- Reduced-motion and visible keyboard focus are handled globally in
  `app/globals.css`.
- Accommodation and Places to Visit content (hotel names, distances, tourist
  spots) was compiled from public travel listings — double-check current
  pricing/availability before publishing.
